...
# --- ĐÃ SỬA LỖI: Sử dụng simple import (bỏ prefix 'scripts.' hoặc '.') ---
# Lý do: Khi chạy file này trực tiếp, các module khác nằm cùng thư mục
...
from upload_youtube import upload_youtube_video # Đảm bảo file này là upload_youtube.py
